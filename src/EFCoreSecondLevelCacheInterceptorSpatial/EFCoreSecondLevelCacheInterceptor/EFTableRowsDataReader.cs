...
namespace EFCoreSecondLevelCacheInterceptor
{
    ...
    public class EFTableRowsDataReader : DbDataReader
    {
        ...
        //public static implicit operator SqlDataReader(EFTableRowsDataReader eFTableRowsDataReader)
        //{
        //    return null;
        //}

        public static explicit operator SqlDataReader(EFTableRowsDataReader eFTableRowsDataReader)
        {
            return null;
        }
    }
